...
window._i18n.en = {
  ...
  'agents.model.cliUnsupported': 'not launchable by the installed CLI ({v}), needs at least {min}',
  ...
  'updates.cli.avx_target':      'Highest version this machine can run: {v}',
  'updates.cli.unmeasured':      'not measurable',
  'updates.cli.unknown':         'unavailable (registry error)',
  'updates.cli.avx_note':        'This machine is x86 without AVX: the latest Claude Code does not launch here, so only the measured AVX-safe version is offered.',
  'updates.cli.offer':           'A newer Claude Code CLI is available: {v}. Nothing installs until you press the button.',
  'updates.cli.btn':             'Update CLI to {v}',
  'updates.cli.confirm':         'Update the Claude Code CLI to {v}. Agent sessions already running keep the old version until their next start. Continue?',
  'updates.cli.sessions_note':   'Agent sessions already running keep the old CLI; the new one is picked up at their next (re)start.',
  'updates.cli.manual':          'Manual alternative:',
  'updates.cli.started':         'CLI update started ({v}). The result will appear here.',
  'updates.cli.running':         'CLI update running ({v})…',

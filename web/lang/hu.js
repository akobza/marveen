...
window._i18n.hu = {
  ...
  'agents.model.cliUnsupported': 'a telepített CLI ({v}) nem futtatja, legalább {min} kell',
  ...
  'updates.cli.avx_target':      'Ezen a gépen ajánlható legmagasabb: {v}',
  'updates.cli.unmeasured':      'nem mérhető',
  'updates.cli.unknown':         'nem elérhető (registry-hiba)',
  'updates.cli.avx_note':        'Ez a gép AVX nélküli x86: a legfrissebb Claude Code itt nem indul el, ezért csak a mért, AVX-biztos verziót ajánljuk fel.',
  'updates.cli.offer':           'Újabb Claude Code CLI érhető el: {v}. A frissítés csak a gombra indul.',
  'updates.cli.btn':             'CLI frissítése erre: {v}',
  'updates.cli.confirm':         'Claude Code CLI frissítése erre: {v}. A már futó ügynök-sessionök a régi verzión maradnak a következő indításukig. Indítsam?',
  'updates.cli.sessions_note':   'A már futó ügynök-sessionök a régi CLI-n maradnak, az újat a következő (újra)indításuk kapja.',
  'updates.cli.manual':          'Kézzel is futtatható:',
  'updates.cli.started':         'CLI frissítés elindítva ({v}). Az eredmény itt jelenik meg.',
  'updates.cli.running':         'CLI frissítés fut ({v})…',
